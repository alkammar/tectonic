...
import com.morkim.tectonic.usecase.entities.LongPreconditionsUseCase;
...
public class AbortTest extends ConcurrentTectonicTest {
    ...
    public void abort_while_waiting_for_preconditions__onAbort_called() {
        ...
        LongPreconditionsUseCase useCase = UseCase.fetch(LongPreconditionsUseCase.class);
        useCase.setExecutor(new SimpleTriggers());
        InterruptableUseCase sub = UseCase.fetch(InterruptableUseCase.class);
    ...
    @Test
    public void abort_from_secondary_actor__onAbort_not_called() throws InterruptedException {
